...
bool addHead(d_List *&L, int val);
bool addTail(d_List *&L, int val);
...
bool addPos(d_List *&L, int val, int pos);
void removePos(d_List *&L, int val, int pos);
bool addBefore(d_List *&L, int val, int pos);
bool addAfter(d_List *&L, int val, int pos);
...
{
    d_NODE *current1 = L1 ? L1->pHead : nullptr;
    d_NODE *current2 = L2 ? L2->pHead : nullptr;
